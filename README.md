# Awesome-Medical-MCP-Servers [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)
...
- [PantelisGeorgiadis/dicomweb-mcp-server](https://github.com/PantelisGeorgiadis/dicomweb-mcp-server) - A DICOMweb Model Context Protocol (MCP) server implementation.
...
- [brainbytes-dev/engpassradar](https://github.com/brainbytes-dev/engpassradar/tree/main/mcp) - An MCP server providing real-time Swiss medication shortage data. Tools for searching shortages, finding drug alternatives, checking ATC therapeutic groups, and company transparency profiles. Data aggregated daily from official Swiss sources (drugshortage.ch, BWL, Spitalpharmazie USB). Remote endpoint at mcp.engpassradar.ch.
